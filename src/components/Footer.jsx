function Footer() {
  return (
    <div className="flex px-20 pt-40 pb-20 w-full h-screen bg-zinc-800 !text-white">
      <div className="w-1/2 h-full flex flex-col justify-between  ">
        <h3 className="text-9xl leading-[10vh] font-['Bebas_Neue'] font-semibold uppercase">
          Eye-
          <br /> Opening
        </h3>
        <div className="logo">
      ...
      <div className="w-1/2 h-full flex flex-col">
        ...
        <div className="w-full h-full flex mt-20 text-2xl">
          <div className="w-1/2 flex flex-col gap-4 justify-between  text-white">
            <div className="Socials">
              <p className="mb-4 text-white">S:</p>
            ...
            <div className="Location">
              <p className="mb-4 text-white">L:</p>
              <ul className="underline flex flex-col gap-2">
                <li>
                  <a href="/">89-289W 4th Ave Vancouver, Canada</a>
                </li>
                <li>
                  <a href="/">30, Levion, SK</a>
                </li>
              </ul>
            </div>
            <div className="email">
              <p className="mb-4 text-white">E:</p>
              <ul className="underline flex flex-col gap-2">
                <li>
                  <a href="/">kumarabhishek282001@gamil.com</a>
                </li>
              </ul>
            </div>
          </div>
          <div className="w-1/2 flex flex-col justify-center items-end">
            <div>
              <p className="mb-4 text-white">M:</p>
              <ul className="underline flex flex-col gap-2">
                <li>
                  <a href="/">Home</a>
                </li>
